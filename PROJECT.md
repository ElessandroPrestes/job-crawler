...
- **[Feature/SPEC-017]** Busca Dinâmica por Palavra-chave: O dashboard agora possui um campo de texto para definir a palavra-chave antes de rodar o crawler, substituindo a string hardcoded e resolvendo problemas onde plataformas como LinkedIn não retornavam resultados por excesso de restrições ("AND" implícito).
